...
const DEFAULT_CONTENT: ResumeContent = {
    ...
    skills: [
        {
            ...
            items: 'Escrita, resolução de problemas, proatividade, comunicação, trabalho em equipe.',
        },
        { category: 'Linguagens', items: 'Português Nativo, Inglês B1.' },
        {
            category: 'Linguagens de Programação',
            items: 'PHP, Javascript, Typescript, Python, Java.',
        },
        {
            category: 'Frontend',
            items: 'HTML5, CSS3, Tailwind CSS, React, Next.js, Vue.js.',
        },
        {
            category: 'Backend',
            items: 'Laravel, Node.js, Express.js, Nest.js, MySQL, PostgreSQL, MongoDB, Redis.',
        },
        {
            category: 'DevOps',
            items: 'Git, Github, Docker, CI/CD, Testes Automatizados, AWS.',
        },
        {
            category: 'Inteligência Artificial',
            items: 'Agentes de LLM (ex. Claude Code), n8n.',
        },
    ...
    experiences: [
        ...
        },
        {
            ...
            location: 'Pelotas',
            description:
                'Desenvolvimento de jogos com scratch para o ensino de algoritmos e lógica de programação.',
...
export default function ResumeBuilder({
    ...
    function removeSkill(i: number) {
        setContent((c) => ({
            ...c,
            skills: c.skills.filter((_, idx) => idx !== i),
        }));
    }
    ...
    function removeCourse(i: number) {
        setContent((c) => ({
            ...c,
            courses: c.courses.filter((_, idx) => idx !== i),
        }));
    }
    ...
    function removePub(i: number) {
        setContent((c) => ({
            ...c,
            publications: (c.publications ?? []).filter((_, idx) => idx !== i),
        }));
    }
    ...
    function addProj() {
        setContent((c) => ({
            ...
            projects: [
                ...(c.projects ?? []),
                { name: '', link: '', period: '', description: '', tags: '' },
            ],
        }));
    }
    ...
    function removeProj(i: number) {
        setContent((c) => ({
            ...c,
            projects: (c.projects ?? []).filter((_, idx) => idx !== i),
        }));
    }

    function handleSave() {
        setSaving(true);
        const payload = { ...meta, content } as unknown as Parameters<
            typeof router.put
        >[1];
        const options = {
            preserveState: true,
    ...
    return (
        <div className="flex h-full overflow-hidden">
            {/* Left panel — form */}
            <div className="w-1/2 space-y-3 overflow-y-auto border-r p-4">
                {/* Metadata */}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <Field label="Localização">
                            <Input
                                ...
                                onChange={(e) =>
                                    updateHeader('location', e.target.value)
                                }
                        ...
                        <Field label="E-mail">
                            <Input
                                ...
                                onChange={(e) =>
                                    updateHeader('email', e.target.value)
                                }
                        ...
                        <Field label="Telefone">
                            <Input
                                ...
                                onChange={(e) =>
                                    updateHeader('phone', e.target.value)
                                }
                        ...
                        <Field label="LinkedIn">
                            <Input
                                ...
                                onChange={(e) =>
                                    updateHeader('linkedin', e.target.value)
                                }
                        ...
                        <Field label="Website">
                            <Input
                                value={content.header.website}
                                onChange={(e) =>
                                    updateHeader('website', e.target.value)
                                }
                                placeholder="https://..."
                            />
                        </Field>
                        <Field label="GitHub">
                            <Input
                                ...
                                onChange={(e) =>
                                    updateHeader('github', e.target.value)
                                }
                ...
                <SectionCard title="Habilidades">
                    {content.skills.map((skill, i) => (
                        ...
                        >
                            ...
                            <Input
                                value={skill.items}
                                onChange={(e) =>
                                    updateSkill(i, 'items', e.target.value)
                                }
                    ...
                    <Button
                        ...
                        className="w-full"
                    >
                        <IconPlus className="mr-1 size-4" /> Adicionar categoria
                    </Button>
                </SectionCard>
                ...
                <SectionCard title="Experiência Profissional">
                        ...
                        <div key={i} className="space-y-2 rounded border p-3">
                            ...
                            <Field label="Tags (separadas por vírgula)">
                                <Input
                                    value={exp.tags}
                                    onChange={(e) =>
                                        updateExp(i, 'tags', e.target.value)
                                    }
                    ...
                    <Button
                        ...
                        className="w-full"
                    >
                        <IconPlus className="mr-1 size-4" /> Adicionar
                        experiência
                    </Button>
                </SectionCard>
                ...
                <SectionCard title="Educação">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <Field label="Grau / Curso">
                                    <Input
                                        ...
                                        placeholder="Licenciatura em Computação"
                                    />
                                </Field>
                    ...
                    <Button
                        ...
                        className="w-full"
                    >
                        <IconPlus className="mr-1 size-4" /> Adicionar formação
                    </Button>
                </SectionCard>
                ...
                <SectionCard title="Cursos">
                        ...
                        <div key={i} className="space-y-2 rounded border p-3">
                            ...
                            <Field label="Tags (separadas por vírgula)">
                                <Input
                                    value={course.tags}
                                    onChange={(e) =>
                                        updateCourse(i, 'tags', e.target.value)
                                    }
                    ...
                    <Button
                        ...
                        className="w-full"
                    >
                        <IconPlus className="mr-1 size-4" /> Adicionar curso
                    </Button>
                </SectionCard>
