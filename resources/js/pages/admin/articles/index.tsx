...
export default function Articles({ articles }: Props) {
    ...
    const filteredArticles = articles.filter((article) => {
        ...
        return (
            matchesSearch && matchesMedium && matchesFavorite && matchesCategory
        );
    });
        ...
        <>
                ...
                <SheetContent className="flex flex-col overflow-hidden">
                    {editingArticle && (
                        <Form
                            ...
                            {...ArticlesController.update.form({
                                article: editingArticle.id,
                            })}
                                    ...
                                    <div className="flex-1 space-y-4 overflow-y-auto px-4 py-2">
                                        ...
                                        <div className="grid gap-1.5">
                                            ...
                                            <Input
                                                ...
                                                type="url"
                                                defaultValue={
                                                    editingArticle.external_link ??
                                                    ''
                                                }
                                                placeholder="https://..."
                                            />
                                            <InputError
                                                message={errors.external_link}
                                            />
                                        </div>
            ...
            >
                <DialogContent>
                    ...
                    {deleteArticle && (
                        <Form
                            {...ArticlesController.destroy.form({
